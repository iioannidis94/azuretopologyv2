...
js/
  ...
  state/
    ...
    resources/
      categories/            category-based Azure resource catalog modules (compute, network, data, ...)
      index.js               aggregates definitions, rules, Azure type mappings, default-config helpers
  canvas/
