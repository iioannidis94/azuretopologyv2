...
window._addNsgRule = addNsgRule;
window._deleteNsgRule = deleteNsgRule;
window._updateNsgRule = updateNsgRule;
window._addRoute = addRoute;
window._deleteRoute = deleteRoute;
window._updateRoute = updateRoute;
...
window._addKeyVaultSecret = addKeyVaultSecret;
window._deleteKeyVaultSecret = deleteKeyVaultSecret;
window._updateKeyVaultSecret = updateKeyVaultSecret;
window._addKeyVaultKey = addKeyVaultKey;
window._deleteKeyVaultKey = deleteKeyVaultKey;
window._updateKeyVaultKey = updateKeyVaultKey;
window._addKeyVaultCertificate = addKeyVaultCertificate;
window._deleteKeyVaultCertificate = deleteKeyVaultCertificate;
window._updateKeyVaultCertificate = updateKeyVaultCertificate;
window._addRbacAssignment = addRbacAssignment;
window._deleteRbacAssignment = deleteRbacAssignment;
window._updateRbacAssignment = updateRbacAssignment;
window._addAgwBackendPool = addAgwBackendPool;
window._deleteAgwBackendPool = deleteAgwBackendPool;
window._updateAgwBackendPool = updateAgwBackendPool;
window._addWafCustomRule = addWafCustomRule;
window._deleteWafCustomRule = deleteWafCustomRule;
window._updateWafCustomRule = updateWafCustomRule;
