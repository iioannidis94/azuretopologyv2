...
export const RES_TYPES={
  ...
  nva:{icon:'🧱', img:'Firewalls.svg', color:'#E81123',label:'FortiGate NVA',cat:'network', cost: 600, config:{mode:'Active/Passive',vendor:'Fortinet',version:'7.4',licenseType:'PAYG',size:'Standard_F4s_v2'}},
  ...
  bas:{icon:'🔒', img:'Private-Link.svg', color:'#0078D4',label:'Azure Bastion',cat:'network', cost: 190, config:{sku:'Standard',scaleUnits:'2',shareableLink:'false',ipConnect:'true',tunneling:'true'}},
  ...
  pe:{icon:'🔌', img:'Private-Link.svg', color:'#8764B8',label:'Private Endpoint',cat:'network', cost: 10, config:{target:'Storage',groupId:'blob',privateDnsZoneId:'',connectionName:'',subResource:'blob',targetResourceId:'',targetResourceName:''}},
  ...
  udr:{icon:'🛣️', img:'Route-Tables.svg', color:'#E81123',label:'Route Table',cat:'network', cost: 0, config:{disableBgpRoutePropagation:'false', routes:[{name:'default-route',addressPrefix:'0.0.0.0/0',nextHopType:'VirtualAppliance',nextHopIpAddress:''}]}},
  natgw:{icon:'🚪', img:'NAT.svg', color:'#0078D4',label:'NAT Gateway',cat:'network', cost: 35, config:{sku:'Standard',idleTimeoutMinutes:'4',zones:'1',publicIpName:''}},
  asg:{icon:'🏷️', img:'Application-Security-Groups.svg', color:'#00BCF2',label:'App Security Group',cat:'network', cost: 0, config:{description:''}},
  pip:{icon:'📍', img:'Public-IP-Addresses.svg', color:'#00BCF2',label:'Public IP Address',cat:'network', cost: 4, config:{sku:'Standard',allocationMethod:'Static',tier:'Regional',zones:'1,2,3',ddosProtection:'false',domainNameLabel:''}},
  sql:{icon:'🗄️', img:'SQL-Database.svg', color:'#00B294',label:'Azure SQL',cat:'data', cost: 380, config:{serverName:'',vcores:'4',tier:'GeneralPurpose',maxSizeGB:'32',collation:'SQL_Latin1_General_CP1_CI_AS',backupRetentionDays:'7',zoneRedundant:'false'}},
  ...
  redis:{icon:'⚡', img:'Cache-Redis.svg', color:'#E81123',label:'Azure Cache Redis',cat:'data', cost: 120, config:{sku:'Premium P1',capacity:'1',enableNonSslPort:'false',minTlsVersion:'1.2',zones:'',replicasPerPrimary:'1'}},
  ...
  apim:{icon:'🔌', img:'API-Management-Services.svg', color:'#FF8C00',label:'API Management',cat:'integration', cost: 700, config:{tier:'Developer',capacity:'1',publisherName:'MyOrganization',publisherEmail:'admin@example.com',vnetType:'None'}},
...
export const PRICING_CALCULATOR_SLUGS={
  ...
  udr:'virtual-network',
  natgw:'virtual-network-nat-gateways',
  asg:'network-security-groups',
  pip:'ip-addresses',
  sql:'sql-database',
  cosmos:'cosmos-db',
  sa:'storage-accounts',
